...
network = 'resnet50_c2sp'  # 'mlp', 'lenet', 'alexnet', 'resnet', 'densenet', 'mobilenet_v1', 'mobilenet_v2', shufflenet_v2

path_load = None
path_save = True   # None, False, True, or specify a dir

l2_decay = {'decay': 0.4e-4, 'exclude': ['batchnorm', 'bias']}
